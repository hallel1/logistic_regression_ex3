...
if __name__ == "__main__":
    ...
    C_param_range, testErrAllModels,optimalLambda=lgr.k_fold_cross_validation(X_train_matrix, y_train_matrix, X_test_matrix,y_test_matrix, k_parameter=10)
    lgr.draw_graph(C_param_range, testErrAllModels)
    lgr.draw_graph2(XMatrix,y,optimalLambda)